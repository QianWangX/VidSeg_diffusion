...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_steps", type=int, default=25, help="number of sampling steps")
    ...
    parser.add_argument("--feature_folder", type=str, default="features_outputs_image_camvid", help="feature folder path")
    ...
    parser.add_argument("--disable_xt_mask", default=False, action="store_true", help="whether to disable xt mask")
    ...
    if args.disable_xt_mask:
        is_xt_mask = False
    else:
        is_xt_mask = True
    print(f"Is xt mask: {is_xt_mask}")
    
    print(f"Is multi attn: {args.is_multi_attn}")
