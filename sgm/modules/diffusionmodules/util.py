...
def get_modulate_lambda(modulate_lambda_start, modulate_lambda_end, modulate_schedule, 
                        total_steps, current_step):
    assert modulate_schedule in ["constant", "linear"]
    if modulate_schedule == "constant":
        modulate_lambda = modulate_lambda_start
    elif modulate_schedule == "linear":
        modulate_lambda = modulate_lambda_start + \
            (modulate_lambda_end - modulate_lambda_start) * current_step / total_steps
            
    return modulate_lambda